...
<body id="index" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
	...
	<dmx-serverconnect id="scItemLists" url="dmxConnect/api/Common/getItems.php"></dmx-serverconnect>
		...
		<div class="d-flex flex-row flex-column-fluid page">
			...
			<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					<!--begin::Subheader-->
					<div id="crDashboardItems" is="dmx-if" dmx-bind:condition="browser1.location.pathname == '/OutlayCopy/'">
...
<!-- Mirrored from preview.keenthemes.com/metronic/demo1/javascript:void(0) by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Sep 2020 08:38:50 GMT -->
