...
<dmx-serverconnect id="scItemList" url="dmxConnect/api/Master/getItemList.php" noload="noload" dmx-param:limit="10" dmx-param:offset="query.offset" dmx-param:sort="" dmx-param:dir=""></dmx-serverconnect>
...
<div class="d-flex flex-column-fluid pt-2 card shadow m-4">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="pagination pagination-lg justify-content-center" dmx-populate="scItemList.data.getCategories" dmx-state="qm" dmx-offset="offset" dmx-generator="bs4paging">
					<li class="page-item" dmx-class:disabled="scItemList.data.getCategories.page.current == 1" aria-label="First">
						<a href="javascript:void(0)" class="page-link" dmx-on:click="qm.set('offset',scItemList.data.getCategories.page.offset.first);scItemList.load()"><span aria-hidden="true">&lsaquo;&lsaquo;</span></a>
					</li>
					<li class="page-item" dmx-class:disabled="scItemList.data.getCategories.page.current == 1" aria-label="Previous">
						<a href="javascript:void(0)" class="page-link" dmx-on:click="qm.set('offset',scItemList.data.getCategories.page.offset.prev);scItemList.load()"><span aria-hidden="true">&lsaquo;</span></a>
					</li>
					<li class="page-item" dmx-class:active="title == scItemList.data.getCategories.page.current" dmx-class:disabled="!active" dmx-repeat="scItemList.data.getCategories.getServerConnectPagination(2,1,'...')">
						<a href="javascript:void(0)" class="page-link" dmx-on:click="qm.set('offset',(page-1)*scItemList.data.getCategories.limit);scItemList.load()">{{title}}</a>
					</li>
					<li class="page-item" dmx-class:disabled="scItemList.data.getCategories.page.current ==  scItemList.data.getCategories.page.total" aria-label="Next">
						<a href="javascript:void(0)" class="page-link" dmx-on:click="qm.set('offset',scItemList.data.getCategories.page.offset.next);scItemList.load()"><span aria-hidden="true">&rsaquo;</span></a>
					</li>
					<li class="page-item" dmx-class:disabled="scItemList.data.getCategories.page.current ==  scItemList.data.getCategories.page.total" aria-label="Last">
						<a href="javascript:void(0)" class="page-link" dmx-on:click="qm.set('offset',scItemList.data.getCategories.page.offset.last);scItemList.load()"><span aria-hidden="true">&rsaquo;&rsaquo;</span></a>
					</li>
